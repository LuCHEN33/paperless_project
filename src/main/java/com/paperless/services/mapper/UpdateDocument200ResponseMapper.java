...
public abstract class UpdateDocument200ResponseMapper implements BaseMapper<DocumentsDocumentEntity, UpdateDocument200Response> {
    @Autowired
    ...
    abstract public DocumentsDocumentEntity dtoToEntity(UpdateDocument200Response dto);
    ...
    abstract public UpdateDocument200Response entityToDto(DocumentsDocumentEntity entity);
    ...
    boolean mapPermissions(AuthUserEntity owner) {
        return true;
    }
