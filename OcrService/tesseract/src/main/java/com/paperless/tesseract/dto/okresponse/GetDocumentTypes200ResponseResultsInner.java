...
public class GetDocumentTypes200ResponseResultsInner {
   ...
   */
  public GetDocumentTypes200ResponseResultsInner(Integer id, String slug, String name, String match, Integer matchingAlgorithm, Boolean isInsensitive, Integer documentCount, Integer owner, GetCorrespondents200ResponseResultsInnerPermissions permissions) {
    this.id = id;
    this.slug = slug;
    this.name = name;
    this.match = match;
  ...
  */
  ...
  public GetDocumentTypes200ResponseResultsInner permissions(GetCorrespondents200ResponseResultsInnerPermissions permissions) {
    this.permissions = permissions;
    return this;
  }
